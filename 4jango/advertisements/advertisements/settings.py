...
SECRET_KEY = 'django-insecure-i@jz-_i2n$^w*whs6$u2+=zzzf5@^7jq)wwm2w(%h9e(!rc1b0'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates', #указывает путь к templates
